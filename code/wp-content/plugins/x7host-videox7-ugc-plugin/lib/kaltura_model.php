...
class KalturaModel 
{
	...
	function getAdminSession($privileges = "", $username = "anonymous")
    {
        $userId = KalturaHelpers::getLoggedUserId();
        $partnerId = get_option("kaltura_partner_id");
		return $this->createKS($partnerId, $username, KalturaSessionType_ADMIN, $privileges);        
    }
    
    function getClientSideSession($privileges = "", $expiry = 86400, $username = "anonymous")
    {
        $userId = KalturaHelpers::getLoggedUserId();
        $partnerId = get_option("kaltura_partner_id");
        return $this->createKS($partnerId, $username, KalturaSessionType_USER, $privileges, $expiry);
    }
