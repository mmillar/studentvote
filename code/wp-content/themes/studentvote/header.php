  ...
  <div id="canvas">
      ...
      <div id="top-section">
	      ...
	      <tbody><tr>
	        ...
	        <table cellspacing="0" cellpadding="0" border="0">
	          <tbody><tr>
	            <td align="left" style="padding-right:17px;"><a class="toplink" href="http://election.studentvote.ca">English</a></td>
	            <td align="left" style="padding-right:12px;"><a class="toplink" href="http://electionfr.studentvote.ca"><strong>Français</strong></a></td>
    ...
    <div id="nav-section">
	    <div class="nav-bar">
			...
			<div class="<?php echo((is_page('Debates')||strpos($_SERVER['REQUEST_URI'],"debates/"))?"":"in") ?>active events" onclick="jumpToURL('<?php bloginfo('url'); ?>/debates');" onkeypress="jumpToCheckedURL('<?php bloginfo('url'); ?>/debates',event);" tabindex=2>Débats</div>
